...
<body>
 ...
 <div id="top-navigation">
  <div class="container">
   ...
   <ul class="social pull-right">
    <li><a href="#" data-placement="bottom" data-original-title="Find us on LinkedIn"><img src="{{ asset('theme/frontend/one/images/social/infocus/linkedin-logo.png') }}" alt="LinkedIn"></a></li>
     <li><a href="#" data-placement="bottom" data-original-title="Find us on Flickr"><img src="{{ asset('theme/frontend/one/images/social/infocus/flickr.png') }}" alt="Flickr"></a></li>
     ...
     <li><a href="#" data-placement="bottom" data-original-title="Follow on DeviantArt"><img src="{{ asset('theme/frontend/one/images/social/infocus/deviantart.png') }}" alt="DeviantArt"></a></li>
    <li><a href="#" data-placement="bottom" data-original-title="Follow on Twitter"><img src="{{ asset('theme/frontend/one/images/social/infocus/twitter.png') }}" alt="Twitter"></a></li>
    <li><a href="#" data-placement="bottom" data-original-title="Follow on Stumbleupon"><img src="{{ asset('theme/frontend/one/images/social/infocus/stumbleupon.png') }}" alt="Stumbleupon"></a></li>
    <li><a href="#" data-placement="bottom" data-original-title="Call us via Skype"><img src="{{ asset('theme/frontend/one/images/social/infocus/skype.png') }}" alt="Skype"></a></li>
   </ul>
 ...
 <div id="footer">
  <div class="container">
   ...
   <ul class="social pull-right">
    <li><a href="#" title="Youtube"><img src="{{ asset('theme/frontend/one/images/social/f0101/youtube.png') }}" alt="Youtube" /></a></li>
    <li><a href="#" title="LinkedIn"><img src="{{ asset('theme/frontend/one/images/social/f0101/linkedin.png') }}" alt="LinkedIn" /></a></li>
    <li><a href="#" title="Vimeo"><img src="{{ asset('theme/frontend/one/images/social/f0101/vimeo.png') }}" alt="Vimeo" /></a></li>
    <li><a href="#" title="Tumblr"><img src="{{ asset('theme/frontend/one/images/social/f0101/tumblr.png') }}" alt="Tumblr" /></a></li>
    <li><a href="#" title="Flickr"><img src="{{ asset('theme/frontend/one/images/social/f0101/flickr.png') }}" alt="Flickr" /></a></li>
    <li><a href="#" title="DeviantArt"><img src="{{ asset('theme/frontend/one/images/social/f0101/deviantart.png') }}" alt="DeviantArt" /></a></li>
    ...
    <li><a href="#" title="Twitter"><img src="{{ asset('theme/frontend/one/images/social/f0101/twitter.png') }}" alt="Twitter" /></a></li>
   </ul>
